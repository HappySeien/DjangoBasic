...
-- Выполнено
Так же добавил таблицу с контактами, все равно ее потом скорее всего делать.
...
7. (**) После создания всех моделей и наполнения их данными посредством механизма миграций перенесите данные из одного поля через промежуточную модель. 
Для каждой операции — отдельная миграция.
...
p.s
Подружил все данные из базы с выводом на страницах, потестил, вроде ошибок нигде не падает